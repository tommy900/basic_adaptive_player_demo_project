  ...
  var BasicPlayer = function() {
    ...
    this.initiate = function(sourceFile, clusterFile) {
      ...
      self.downloadClusterData(function() {
        ...
        document.getElementById('basic-player').append(self.videoElement);
        ...
        script.async = true;
        document.getElementsByTagName('video')[0].appendChild(script);
      });
    }
    ...
    this.switchRendition = function(rendition) {
      ...
      self.downloadUpcomingClusters();
      document.getElementById('rendition').value = rendition;
    }
